...
when defined(dynusb):
  ...
  {.pragma: libusbBinding, dynlib: dllname.}
else:
  import os
  const 
    coSourcePath = currentSourcePath().splitFile.dir
    libusbSourcePath = joinPath(coSourcePath, "libusb")
    libusbOsSourcePath = joinPath(libusbSourcePath, "os")

  {.
    passC: "-I"&libusbSourcePath & " -I"&libusbOsSourcePath,
    compile: libusbSourcePath & "/core.c",
    compile: libusbSourcePath & "/descriptor.c",
    compile: libusbSourcePath & "/hotplug.c",
    compile: libusbSourcePath & "/io.c",
    compile: libusbSourcePath & "/sync.c",
    compile: libusbSourcePath & "/strerror.c",

  .}
  when defined(android):
    const linuxConfig = joinPath(coSourcePath, "android")
    {.
      passL: "-lpthread",
      passC: "-I"&linuxConfig,
      compile: libusbOsSourcePath & "/events_posix.c",
      compile: libusbOsSourcePath & "/threads_posix.c",
      compile: libusbOsSourcePath & "/linux_netlink.c",
      compile: libusbOsSourcePath & "/linux_usbfs.c",
    .}
  elif defined(linux):
      # compile: libusbOsSourcePath & "/linux_udev.c",
      # compile: libusbOsSourcePath & "/null_usb.c",
    const linuxConfig = joinPath(coSourcePath, "linux")
    {.
      passL: "-lpthread",
      passC: "-I"&linuxConfig,
      compile: libusbOsSourcePath & "/events_posix.c",
    ...
    const freebsdConfig = joinPath(coSourcePath, "freebsd")
    {.
      passL: "-lpthread",
      passC: "-I"&freebsdConfig,
      compile: libusbOsSourcePath & "/events_posix.c",
      compile: libusbOsSourcePath & "/threads_posix.c",
      compile: libusbOsSourcePath & "/netbsd_usb.c",
      compile: libusbOsSourcePath & "/openbsd_usb.c",
    .}
  elif defined(macosx):
    const macosxConfig = joinPath(coSourcePath, "macosx")
    {.
      passL: "-lpthread",
      passC: "-I"&macosxConfig,
      compile: libusbOsSourcePath & "/events_posix.c",
      compile: libusbOsSourcePath & "/threads_posix.c",
      compile: libusbOsSourcePath & "/darwin_usb.c",
      compile: libusbOsSourcePath & "/sunos_usb.c",
    .}
  elif defined(windows):
...
proc libusbInit*(ctx: ptr ptr LibusbContext): cint
  {.cdecl, libusbBinding, importc: "libusb_init".}
  ## Initializes libusb.
  ##
  ## context
...
proc libusbExit*(ctx: ptr LibusbContext)
  {.cdecl, libusbBinding, importc: "libusb_exit".}
  ## Shuts down libusb.
  ##
  ## ctx
...
proc libusbSetDebug*(ctx: ptr LibusbContext; level: cint)
  {.cdecl, libusbBinding, importc: "libusb_set_debug".}
...
proc libusbGetVersion*(): ptr LibusbVersion
  {.cdecl, libusbBinding, importc: "libusb_get_version".}
...
proc libusbHasCapability*(capability: LibusbCapability): cint
  {.cdecl, libusbBinding, importc: "libusb_has_capability".}
...
proc libusbErrorName*(errcode: cint): cstring
  {.cdecl, libusbBinding, importc: "libusb_error_name".}
...
proc libusbSetLocale*(locale: cstring): cint
  {.cdecl, libusbBinding, importc: "libusb_setlocale".}
...
proc libusbStrError*(errcode: cint): cstring
  {.cdecl, libusbBinding, importc: "libusb_strerror".}
...
proc libusbFreeDeviceList*(list: ptr LibusbDeviceArray; unrefDevices: cint)
  {.cdecl, libusbBinding, importc: "libusb_free_device_list".}
...
proc libusbRefDevice*(dev: ptr LibusbDevice): ptr LibusbDevice
  {.cdecl, libusbBinding, importc: "libusb_ref_device".}
...
proc libusbUnrefDevice*(dev: ptr LibusbDevice)
  {.cdecl, libusbBinding, importc: "libusb_unref_device".}
...
proc libusbGetConfiguration*(dev: ptr LibusbDeviceHandle; config: ptr cint):
  cint {.cdecl, libusbBinding, importc: "libusb_get_configuration".}
...
proc libusbGetDeviceDescriptor*(dev: ptr LibusbDevice;
  ...
  {.cdecl, libusbBinding, importc: "libusb_get_device_descriptor".}
...
proc libusbGetActiveConfigDescriptor*(dev: ptr LibusbDevice;
  ...
  {.cdecl, libusbBinding, importc: "libusb_get_active_config_descriptor".}
...
proc libusbGetConfigDescriptor*(dev: ptr LibusbDevice;
  ...
  {.cdecl, libusbBinding, importc: "libusb_get_config_descriptor".}
...
proc libusbGetConfigDescriptorByValue*(dev: ptr LibusbDevice;
  ...
  {.cdecl, libusbBinding, importc: "libusb_get_config_descriptor_by_value".}
...
proc libusbFreeConfigDescriptor*(config: ptr LibusbConfigDescriptor)
  {.cdecl, libusbBinding, importc: "libusb_free_config_descriptor".}
...
proc libusbGetSsEndpointCompanionDescriptor*(ctx: ptr LibusbContext;
  ...
  {.cdecl, libusbBinding, importc: "libusb_get_ss_endpoint_companion_descriptor".}
...
proc libusbFreeSsEndpointCompanionDescriptor*(
  ...
  {.cdecl, libusbBinding, importc: "libusb_free_ss_endpoint_companion_descriptor".}
...
proc libusbGetBosDescriptor*(handle: ptr LibusbDeviceHandle;
  ...
  {.cdecl, libusbBinding, importc: "libusb_get_bos_descriptor".}
...
proc libusbFreeBosDescriptor*(bos: ptr LibusbBosDescriptor)
  {.cdecl, libusbBinding, importc: "libusb_free_bos_descriptor".}
...
proc libusbGetUsb20ExtensionDescriptor*(ctx: ptr LibusbContext;
  ...
  {.cdecl, libusbBinding, importc: "libusb_get_usb_2_0_extension_descriptor".}
...
proc libusbFreeUsb20ExtensionDescriptor*(
  ...
  {.cdecl, libusbBinding, importc: "libusb_free_usb_2_0_extension_descriptor".}
...
proc libusbGetSsUsbDeviceCapabilityDescriptor*(ctx: ptr LibusbContext;
  ...
  {.cdecl, libusbBinding, importc: "libusb_get_ss_usb_device_capability_descriptor".}
...
proc libusbFreeSsUsbDeviceCapabilityDescriptor*(
  ...
  {.cdecl, libusbBinding, importc: "libusb_free_ss_usb_device_capability_descriptor".}
...
proc libusbGetContainerIdDescriptor*(ctx: ptr LibusbContext;
  ...
  {.cdecl, libusbBinding, importc: "libusb_get_container_id_descriptor".}
...
proc libusbFreeContainerIdDescriptor*(
  ...
  {.cdecl, libusbBinding, importc: "libusb_free_container_id_descriptor".}
...
proc libusbGetBusNumber*(dev: ptr LibusbDevice): uint8
  {.cdecl, libusbBinding, importc: "libusb_get_bus_number".}
...
proc libusbGetPortNumber*(dev: ptr LibusbDevice): uint8
  {.cdecl, libusbBinding, importc: "libusb_get_port_number".}
...
proc libusbGetPortNumbers*(dev: ptr LibusbDevice;
  ...
  {.cdecl, libusbBinding, importc: "libusb_get_port_numbers".}
...
proc libusbGetParent*(dev: ptr LibusbDevice): ptr LibusbDevice
  {.cdecl, libusbBinding, importc: "libusb_get_parent".}
...
proc libusbGetDeviceAddress*(dev: ptr LibusbDevice): uint8
  {.cdecl, libusbBinding, importc: "libusb_get_device_address".}
...
proc libusbGetDeviceSpeed*(dev: ptr LibusbDevice): cint
  {.cdecl, libusbBinding, importc: "libusb_get_device_speed".}
...
proc libusbGetMaxPacketSize*(dev: ptr LibusbDevice; endpoint: cuchar): cint
  {.cdecl, libusbBinding, importc: "libusb_get_max_packet_size".}
...
proc libusbGetMaxIsoPacketSize*(dev: ptr LibusbDevice; endpoint: cuchar): cint
  {.cdecl, libusbBinding, importc: "libusb_get_max_iso_packet_size".}
...
proc libusbOpen*(dev: ptr LibusbDevice; handle: ptr ptr LibusbDeviceHandle):
  cint {.cdecl, libusbBinding, importc: "libusb_open".}
...
proc libusbClose*(devHandle: ptr LibusbDeviceHandle)
  {.cdecl, libusbBinding, importc: "libusb_close".}
...
proc libusbGetDevice*(devHandle: ptr LibusbDeviceHandle): ptr LibusbDevice
  {.cdecl, libusbBinding, importc: "libusb_get_device".}
...
proc libusbSetConfiguration*(dev: ptr LibusbDeviceHandle;
  ...
  {.cdecl, libusbBinding, importc: "libusb_set_configuration".}
...
proc libusbClaimInterface*(dev: ptr LibusbDeviceHandle;
  ...
  {.cdecl, libusbBinding, importc: "libusb_claim_interface".}
...
proc libusbReleaseInterface*(dev: ptr LibusbDeviceHandle;
  interfaceNumber: cint): cint
  {.cdecl, libusbBinding, importc: "libusb_release_interface".}
...
proc libusbOpenDeviceWithVidPid*(ctx: ptr LibusbContext;
  ...
  {.cdecl, libusbBinding, importc: "libusb_open_device_with_vid_pid".}
...
proc libusbSetInterfaceAltSetting*(dev: ptr LibusbDeviceHandle;
  ...
  {.cdecl, libusbBinding, importc: "libusb_set_interface_alt_setting".}
...
proc libusbClearHalt*(dev: ptr LibusbDeviceHandle; endpoint: cuchar): cint
  {.cdecl, libusbBinding, importc: "libusb_clear_halt".}
...
proc libusbResetDevice*(dev: ptr LibusbDeviceHandle): cint
  {.cdecl, libusbBinding, importc: "libusb_reset_device".}
...
proc libusbAllocStreams*(dev: ptr LibusbDeviceHandle;
  ...
  {.cdecl, libusbBinding, importc: "libusb_alloc_streams".}
...
proc libusbFreeStreams*(dev: ptr LibusbDeviceHandle;
  ...
  {.cdecl, libusbBinding, importc: "libusb_free_streams".}
...
proc libusbKernelDriverActive*(dev: ptr LibusbDeviceHandle;
  interfaceNumber: cint): cint
  {.cdecl, libusbBinding, importc: "libusb_kernel_driver_active".}
...
proc libusbDetachKernelDriver*(dev: ptr LibusbDeviceHandle;
  interfaceNumber: cint): cint
  {.cdecl, libusbBinding, importc: "libusb_detach_kernel_driver".}
...
proc libusbAttachIKernelDriver*(dev: ptr LibusbDeviceHandle;
  interfaceNumber: cint): cint
  {.cdecl, libusbBinding, importc: "libusb_attach_kernel_driver".}
...
proc libusbSetAutoDetachKernelDriver*(dev: ptr LibusbDeviceHandle;
  enable: cint): cint
  {.cdecl, libusbBinding, importc: "libusb_set_auto_detach_kernel_driver".}
...
proc libusbAllocTransfer*(isoPackets: cint): ptr LibusbTransfer
  {.cdecl, libusbBinding, importc: "libusb_alloc_transfer".}
...
proc libusbSubmitTransfer*(transfer: ptr LibusbTransfer): cint
  {.cdecl, libusbBinding, importc: "libusb_submit_transfer".}
  ## Submit a transfer.
  ##
  ## transfer
...
proc libusbCancelTransfer*(transfer: ptr LibusbTransfer): cint
  {.cdecl, libusbBinding, importc: "libusb_cancel_transfer".}
...
proc libusbFreeTransfer*(transfer: ptr LibusbTransfer)
  {.cdecl, libusbBinding, importc: "libusb_free_transfer".}
...
proc libusbTransferSetStreamId*(transfer: ptr LibusbTransfer;
  streamId: uint32)
  {.cdecl, libusbBinding, importc: "libusb_transfer_set_stream_id".}
...
proc libusbTransferGetStreamId*(transfer: ptr LibusbTransfer): uint32
  {.cdecl, libusbBinding, importc: "libusb_transfer_get_stream_id".}
...
proc libusbBulkTransfer*(devHandle: ptr LibusbDeviceHandle;
  ...
  timeout: cuint): cint
  {.cdecl, libusbBinding, importc: "libusb_bulk_transfer".}
...
proc libusbInterruptTransfer*(devHandle: ptr LibusbDeviceHandle;
  endpoint: cuchar; data: ptr cuchar; length: cint; actualLength: ptr cint;
  timeout: cuint): cint
  {.cdecl, libusbBinding, importc: "libusb_interrupt_transfer".}
...
proc libusbGetStringDescriptorAscii*(dev: ptr LibusbDeviceHandle;
  ...
  {.cdecl, libusbBinding, importc: "libusb_get_string_descriptor_ascii".}
...
proc libusbTryLockEvents*(ctx: ptr LibusbContext): cint
  {.cdecl, libusbBinding, importc: "libusb_try_lock_events".}
...
proc libusbLockEvents*(ctx: ptr LibusbContext)
  {.cdecl, libusbBinding, importc: "libusb_lock_events".}
...
proc libusbUnlockEvents*(ctx: ptr LibusbContext)
  {.cdecl, libusbBinding, importc: "libusb_unlock_events".}
...
proc libusbEventHandlingOk*(ctx: ptr LibusbContext): cint
  {.cdecl, libusbBinding, importc: "libusb_event_handling_ok".}
...
proc libusbEventHandlerActive*(ctx: ptr LibusbContext): cint
  {.cdecl, libusbBinding, importc: "libusb_event_handler_active".}
...
proc libusbLockEventWaiters*(ctx: ptr LibusbContext)
  {.cdecl, libusbBinding, importc: "libusb_lock_event_waiters".}
...
proc libusbUnlockEventWaiters*(ctx: ptr LibusbContext)
  {.cdecl, libusbBinding, importc: "libusb_unlock_event_waiters".}
...
proc libusbWaitForEvent*(ctx: ptr LibusbContext; tv: ptr LibusbTimeval): cint
  {.cdecl, libusbBinding, importc: "libusb_wait_for_event".}
...
proc libusbHandleEvents*(ctx: ptr LibusbContext): cint
  {.cdecl, libusbBinding, importc: "libusb_handle_events".}
...
proc libusbHandleEventsLocked*(ctx: ptr LibusbContext; tv: ptr LibusbTimeval):
  cint {.cdecl, libusbBinding, importc: "libusb_handle_events_locked".}
...
proc libusbPollfdsHandleTimeouts*(ctx: ptr LibusbContext): cint
  {.cdecl, libusbBinding, importc: "libusb_pollfds_handle_timeouts".}
...
proc libusbGetNextTimeout*(ctx: ptr LibusbContext; tv: ptr LibusbTimeval): cint
  {.cdecl, libusbBinding, importc: "libusb_get_next_timeout".}
...
proc libusbGetPollfds*(ctx: ptr LibusbContext): ptr ptr LibusbPollfd
  {.cdecl, libusbBinding, importc: "libusb_get_pollfds".}
...
proc libusbSetPollfdNotifiers*(ctx: ptr LibusbContext;
  ...
  userData: pointer)
  {.cdecl, libusbBinding, importc: "libusb_set_pollfd_notifiers".}
...
proc libusbHotplugRegisterCallback*(ctx: ptr LibusbContext; events: cint;
  ...
  {.cdecl, libusbBinding, importc: "libusb_hotplug_register_callback".}
...
proc libusbHotplugDeregisterCallback*(ctx: ptr LibusbContext; handle: LibusbHotplugCallbackHandle)
  {.cdecl, libusbBinding, importc: "libusb_hotplug_deregister_callback".}
